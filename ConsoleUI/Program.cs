...
namespace Console1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var result = rentalManager.Update(new Rental { RentalId = 5015, CarId = 2, CustomerId = 2, RentDate = new DateTime(2021, 03, 14), ReturnDate = new DateTime(2021, 02, 13) });
        ...
        private static void CarDetailGetAllTest()
        {
            ...
            if (result.Success == true)
            {
                ...
                foreach (var cardetail in result.Data)
                {
                    ...
                    Console.WriteLine("Descriptions: " + cardetail.Descriptions + "\n");
                }
                Console.WriteLine(result.Message);
